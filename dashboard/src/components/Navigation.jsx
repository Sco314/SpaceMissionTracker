      ...
      {TABS.map(({ id, label, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className={`relative flex-1 sm:flex-none flex flex-col sm:flex-row items-center justify-center gap-px sm:gap-1.5 px-1 sm:px-3 py-1.5 sm:py-2 text-[10px] sm:text-xs font-medium transition-all active:scale-95 ${
              isActive
                ? 'text-white'
