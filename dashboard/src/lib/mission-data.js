...
export const MISSION_EVENTS = [
  ...
  {
    type: 'otc-burn',
    time: new Date('2026-04-10T18:53:00Z'),
    label: 'Return Burn 3',
    description: 'Third return trajectory correction burn refines Orion\'s path for atmospheric entry and splashdown.',
    details: 'At 2:53 p.m. EDT, the spacecraft performs precise adjustments to stay on its targeted course home, fine-tuning the trajectory for the upcoming atmospheric entry sequence.',
  },
  {
    type: 'live-coverage',
    ...
    details: 'Live broadcast coverage starts at 6:30 p.m. EDT (5:30 p.m. CDT / 4:30 p.m. PDT) on NASA+, YouTube, Netflix, Peacock, Prime Video, and HBO Max ahead of atmospheric entry and splashdown in the Pacific Ocean off the coast of San Diego.',
  },
  {
    type: 'separation',
    time: new Date('2026-04-10T23:33:00Z'),
    label: 'CM/SM Separation',
    description: 'Orion\'s crew module separates from the service module, exposing its heat shield for reentry.',
    details: 'At 7:33 p.m. EDT, the crew module detaches from the European Service Module. The heat shield is now exposed for the spacecraft\'s return through Earth\'s atmosphere, where it will encounter temperatures of about 3,000 degrees Fahrenheit.',
  },
  {
    type: 'otc-burn',
    time: new Date('2026-04-10T23:37:00Z'),
    label: 'CM Raise Burn',
    description: 'An 18-second crew module raise burn sets the proper entry angle and aligns the heat shield.',
    details: 'At 7:37 p.m. EDT, following separation from the service module, Orion performs an 18-second burn to set the proper entry angle and align the heat shield for atmospheric interface.',
  },
  {
    type: 'entry-interface',
    time: new Date('2026-04-10T23:53:00Z'),
    label: 'Entry Interface',
    description: 'Orion reaches 400,000 feet above Earth traveling nearly 35 times the speed of sound. Six-minute comms blackout begins.',
    details: 'At 7:53 p.m. EDT, Orion reaches atmospheric entry interface at 400,000 feet. The crew is expected to experience up to 3.9 Gs in the planned entry profile. This marks first contact with the upper atmosphere and the start of a planned six-minute communications blackout as plasma builds around the capsule.',
  },
  {
    type: 'parachute',
    time: new Date('2026-04-11T00:03:00Z'),
    label: 'Drogue Chutes Deploy',
    description: 'Drogue parachutes deploy at around 22,000 feet, slowing and stabilizing the capsule.',
    details: 'At 8:03 p.m. EDT, around 22,000 feet altitude, the drogue parachutes deploy to slow and stabilize the capsule as Orion nears splashdown.',
  },
  {
    type: 'parachute',
    time: new Date('2026-04-11T00:04:00Z'),
    label: 'Main Chutes Deploy',
    description: 'Three main parachutes deploy at 6,000 feet, reducing Orion\'s speed to less than 136 mph.',
    details: 'At 8:04 p.m. EDT, around 6,000 feet altitude, the drogue chutes release and three main parachutes deploy, dramatically reducing Orion\'s speed to less than 136 mph for final descent.',
  },
  {
    type: 'splashdown',
